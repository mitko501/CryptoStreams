...
namespace block {
    ...
    void road_runner128::keysetup(const std::uint8_t *key, const std::uint64_t keysize) {
    ...
    void road_runner80::keysetup(const std::uint8_t *key, const std::uint64_t keysize) {
