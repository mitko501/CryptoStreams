...
namespace block {
    ...
    class sparx128 : public sparx<SPARX_ROUND_KEYS_SIZE128, SPARX_BLOCK_SIZE128> {
    private:
    ...
    public:
        sparx128(size_t rounds) : sparx(rounds) {}
    };

    class sparx64 : public sparx<SPARX_ROUND_KEYS_SIZE64, SPARX_BLOCK_SIZE64> {
    private:
    ...
    public:
        sparx64(size_t rounds) : sparx(rounds) {}
